...
const NotAvailableResult = () => (
	<Result>
		<p style={{ textAlign: 'center' }}>PaymentRequest is not available in your browser.</p>
...
const InjectedCheckoutForm = () => (
	<ElementsConsumer>{({ stripe }) => <CheckoutForm stripe={stripe} />}</ElementsConsumer>
)
